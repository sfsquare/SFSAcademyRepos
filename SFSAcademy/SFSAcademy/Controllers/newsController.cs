...
namespace SFSAcademy.Controllers
{
    public class newsController : Controller
    {
        ...
        {
            var newsComment = db.NEWS_COMMENTS.Find(commentId);
            //NEWS_COMMENTS nwcomment = new NEWS_COMMENTS();
            //nwcomment.CNTNT = newsComment.CNTNT;
            //nwcomment.AUTH_ID = newsComment.AUTH_ID;
            //nwcomment.CREATED_AT = newsComment.CREATED_AT;
            //nwcomment.UPDATED_AT = System.DateTime.Now;
            //nwcomment.ID = commentId;
            //nwcomment.NEWS_ID = newsId;
